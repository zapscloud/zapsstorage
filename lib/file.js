...
module.exports = class File {
    ...
    uploadFile(folderpath, fullfilepath, ispublic) {
        return new Promise((resolve, reject) => {
            ...
            fs.readFile(path.join(fullfilepath), (err, fileData) => {
                ...
                axios.post(`${this.zapsurl}/storages/${folderpath}${_ispulbic}`, formData, this.header_param)
    ...
    removeFile(fullfilepath) {
        return new Promise((resolve, reject) => {
            axios.delete(`${this.zapsurl}/storages/${fullfilepath}`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
    ...
    getFileDetail(fullfilepath) {
        return new Promise((resolve, reject) => {
            axios.get(`${this.zapsurl}/storages/${fullfilepath}?action=stat`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
    ...
    getFile(fullfilepath, downloadpath) {
        return new Promise((resolve, reject) => {
            console.log('File key ', fullfilepath, downloadpath)
            var _url = `${this.zapsurl}/storages/${fullfilepath}`;
    ...
    getFileList(folderpath) {
        return new Promise((resolve, reject) => {
            axios.get(`${this.zapsurl}/storages/${folderpath}?action=list`, this.header_param)
                .then(function (response) {
                    return resolve(response.data);
                })
                .catch(function (error) {
